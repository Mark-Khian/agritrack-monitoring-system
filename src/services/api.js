...
export const exportHarvestsCSV = (params = {}) => API.get('/harvests/export/csv', { params, responseType: 'blob' });
export const exportHarvestsPDF = (params = {}) => API.get('/harvests/export/pdf', { params, responseType: 'blob' });
export default API;