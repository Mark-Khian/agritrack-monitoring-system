                                            ...
                                            {isExpanded && (
                                                <div className="px-4 pb-3 space-y-2">
                                                    {group.activities.map((act) => {
                                                        ...
                                                        const rowBg = isSystem ? 'bg-gray-50' : 'bg-emerald-50/70';
                                                        const textColor = isSystem ? 'text-gray-700' : 'text-emerald-900';
                                                        return (
                                                            <div
                                                                key={act.id}
                                                                className={`rounded-lg border border-gray-100 px-3 py-2 ${rowBg}`}
                                                            >
                                                                <div className="flex items-start justify-between gap-3">
                                                                    <div className="flex items-start gap-2 min-w-0">
                                                                        {getActivityIcon(act.activity_type)}
                                                                        <p
                                                                            className={`text-sm font-semibold truncate capitalize ${textColor}`}
                                                                        >
